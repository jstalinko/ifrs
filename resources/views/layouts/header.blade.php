    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                        ...
                        <div class="col s12 m4 search-result-container">
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('assets/images/profile-image-1.png')}}" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('assets/images/profile-image-3.jpg')}}" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('assets/images/profile-image.png')}}" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <div class="footer">
                    <p class="copyright">{{date('Y')}} © {{env('APP_NAME')}}</p>
                </div>
                </div>
            </aside>